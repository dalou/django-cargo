(function ($)
{
    function cargo_load_html_input($input, config, id)
    {
        if($input[0].cargo_load_html_input_loaded)
        {
            return;
        }
        ...
        {
            $input[0].cargo_load_html_input_loaded = true;
            config = $input.data('cargo-html_input');
                            ...
                            if(config.placeholder)
                            {
                                ...
                                if (typeof placeholder !== 'undefined' && placeholder !== false)
                                {
                                    ...
                                    function onBlur()
                                    {
                                        ...
                                        if(content == '')
                                        {
                                            var placeholder_html = '<span class="cargo-html_input-placeholder">'+placeholder+'</span>'
    ...
    $(function ()
    {
        $('[data-cargo-html_input]').each(function(i, self)
        {
            cargo_load_html_input($(self));
        });
