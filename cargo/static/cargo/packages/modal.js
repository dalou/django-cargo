...
window.cargo_packages_modal = true;
...
$(document).ready(function(apply_packages_on_insert)
{
    ...
    $(document).on('mousedown', '[data-modal-confirm]', function(e, self)
    {
        ...
        $.magnificPopup.open(
        {
            ...
            callbacks: {
                open: function() {
                    self.trigger('cargo.modal_opened', [])
        ...
        $.magnificPopup.open(
        {
            ...
            callbacks: {
                open: function() {
                    ...
                    trigger.trigger('cargo.modal_opened', [])
                    if(type == "inline" || type == "image") {
                        trigger.trigger('modal.loaded', [$.magnificPopup.instance.content]);
                        trigger.trigger('cargo.modal_loaded', [$.magnificPopup.instance.content]);
                    }
                },
                ajaxContentAdded: function(content) {
                    ...
                    trigger.trigger('cargo.modal_loaded', [this.content]);
