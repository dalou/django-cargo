    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_sent', models.BooleanField(default=False, verbose_name='Envoy\xe9 ?')),
                ('email', models.ForeignKey(to='cargo.Emailing')),
            ],
            options={
                'ordering': ('-date_created',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', cargo.fields.html.HTMLField(verbose_name='Contenu', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Activ\xe9e ?')),
                ('flatpage', models.ForeignKey(related_name='positions', verbose_name=b'Page statique', to='cargo.FlatPage')),
            ],
            options={
