...
class ImageInput(OriginalFileInput):
    template_name = 'cargo/_image_input.html'
...
class CroppedImageInput(forms.widgets.TextInput):
    class Media:
        css = {
            'all': (
                settings.STATIC_URL + 'cargo/image_cropped.css',
            )
        }
        js = (
            settings.STATIC_URL + 'cargo/image_cropped.js',
...
class CroppedImageField(forms.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        widget = CroppedImageInput( attrs={
            ...
            'data-cargo-croppedimage': self.image_field,
            'style': 'display:none;',
        })
