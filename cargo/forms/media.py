...
class MediaInput(forms.widgets.ClearableFileInput):
    template_name = 'cargo/fields/_media_input.html'
    change_message = "Changer"
    empty_message = "Changer"
    class Media:
        css = {
            'all': (
                'cargo/forms/media.css',
            )
        }
        js = (
            'cargo/vendors/media-dropzone/jquery.media-dropzone.js',
            'cargo/forms/media.js',
        )
...
class MediaField(forms.FileField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #     'class': 'cargo-media_field',
        #     # 'data-cargo-media_field': self.image_field,
        #     # 'style': 'display:none;',
        # })
