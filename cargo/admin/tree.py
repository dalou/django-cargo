...
class TreeAdminMixin(object):
    ...
    change_list_template = 'cargo/admin/tree/grid_view.html'
    change_tree_template=  'cargo/admin/tree/change_list.html'
    ...
    def media(self):
        ...
        js = (
            get_jquery_url(),
            'cargo/vendors/jquery-cookie/jquery.cookie.js',
            'cargo/vendors/jqtree/tree.jquery.js',
            'cargo/admin/tree/change_list.js',
        )

        css = dict(
            all=(
                'cargo/vendors/jqtree/jqtree.css',
                'cargo/admin/tree/change_list.css',
            )
        )
