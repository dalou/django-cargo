...
class EmailingAdmin(admin.ModelAdmin):
    change_form_template = 'cargo/emailing/admin/send_form.html'
    ...
    def get_changeform_initial_data(self, request, object_id=None):
        ...
        if request.session.get('cargo-emailing_receivers'):
            receivers = request.session.get('cargo-emailing_receivers')
            del request.session['cargo-emailing_receivers']
        return {
...
class ExtractEmailingAdmin(object):
    ...
    emailing_form_template_name = 'cargo/emailing/admin/extract_emailing.html'
...
class SendMailMixin(object):
    ...
    emailing_form_template_name = 'cargo/emailing/admin/send_form.html'
    ...
    def send_mail(modeladmin, request, queryset):
        ...
        request.session['cargo-emailing_receivers'] = ", ".join(receivers)
        return redirect(reverse('admin:cargo_emailing_add'))
